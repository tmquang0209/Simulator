...
public:
    ...
    int permissionsFile(string targetUser, string targetFile, vector<string> permission, string type, FileInfo &fileInfo, Permission &fileAccess); // assign permissions to other users
};
